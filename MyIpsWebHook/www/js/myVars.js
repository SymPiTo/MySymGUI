...
*/ 
   ...
   function updateIPSValue(ipsID, IPSValue){
    ...
    function updateValues(sym){
        ...
        WetterLabelNow.update(sym[112]['icon'], "Aktuell", sym[112]['apparentTemperature'], sym[112]['temperature'], sym[112]['windSpeed'], sym[112]['windGust'], sym[112]['cloudCover'], sym[112]['humidity'], sym[112]['ozone'], sym[112]['uvIndex'] );
